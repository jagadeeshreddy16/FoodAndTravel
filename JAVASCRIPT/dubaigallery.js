...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../ASSET/Images/dubai/${imagesArray[i]}.jpg)`
    }
    else
    {
        document.getElementById("header").style.backgroundImage=`url(../ASSET/Images/dubai/${imagesArray[i]}.jpg)`
...
{
    img[i].src=`../ASSET/Images/dubai/${i}.jpg`
...
{
    console.log(img)
    document.getElementById("bigimg").setAttribute("src",`../ASSET/Images/dubai/${img}.jpg`)
