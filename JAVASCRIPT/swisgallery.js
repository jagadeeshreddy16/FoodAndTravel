...
function header()
{
    ...
    {
        i=0;
        document.getElementById("header").style.backgroundImage=`url(../ASSET/Images/swis/${imagesArray[i]}.jpg)`
    }
    else
    {
        document.getElementById("header").style.backgroundImage=`url(../ASSET/Images/swis/${imagesArray[i]}.jpg)`
...
{
    img[i].src=`../ASSET/Images/swis/${i}.jpg`
...
{
    console.log(img)
    document.getElementById("bigimg").setAttribute("src",`../ASSET/Images/swis/${img}.jpg`)
